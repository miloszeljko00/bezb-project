...
import com.dreamteam.pki.service.certificate.interfaces.ICertificateGenerator;
...
public class CertificateGenerator implements ICertificateGenerator {
    ...
    @Override
    public X509Certificate generate(Subject subject, Issuer issuer, Date startDate, Date endDate, String serialNumber) {
        try {
